...
from ptsemseg.models.fcn import fcn8s, fcn16s, fcn32s, fcn8sm1, fcn8sm2, fcn8sm3
...
def get_model(model_dict, n_classes, version=None):
    ...
    elif name in ["fcn8sm1", "fcn8sm2", "fcn8sm3"]:
        model = model(nclasses=n_classes, **param_dict)
