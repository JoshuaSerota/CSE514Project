...
class fcn8sm1(nn.Module):
    def __init__(self, n_classes=21, learned_billinear=True):
        super(fcn8sm1, self).__init__()
        self.learned_billinear = learned_billinear
        self.n_classes = n_classes
        self.loss = functools.partial(cross_entropy2d, size_average=False)
...
class fcn8sm2(nn.Module):
    def __init__(self, n_classes=21, learned_billinear=True):
        super(fcn8sm2, self).__init__()
        self.learned_billinear = learned_billinear
        self.n_classes = n_classes
        self.loss = functools.partial(cross_entropy2d, size_average=False)
...
class fcn8sm3(nn.Module):
    def __init__(self, n_classes=21, learned_billinear=True):
        super(fcn8sm3, self).__init__()
        self.learned_billinear = learned_billinear
        self.n_classes = n_classes
        self.loss = functools.partial(cross_entropy2d, size_average=False)
